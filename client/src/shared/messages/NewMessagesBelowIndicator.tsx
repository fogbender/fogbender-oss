  ...
  return (
    <div
      className={classNames(
        ...
        dimmed ? "text-gray-500 delay-1000 duration-1000" : "duration-0 delay-0 text-brand-pink-500"
      )}
      key={`${id}-new-messages-below`}
    >
      <span className="relative z-10 inline-flex items-center gap-x-2 bg-white px-4">
