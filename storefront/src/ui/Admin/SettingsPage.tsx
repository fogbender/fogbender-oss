...
const SettingsTabs: React.FC<{
  ...
  return (
    <div className="max-w-min lg:max-w-full pr-4 lg:pr-0 mt-2 mb-4 sm:mt-8 sm:mb-8 w-full bg-white dark:bg-brand-dark-bg dark:text-white rounded-xl fog:box-shadow-s flex flex-col gap-4">
